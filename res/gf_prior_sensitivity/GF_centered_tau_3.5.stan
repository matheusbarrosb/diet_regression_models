...
model {
  // Hyperpriors
  tau_alpha ~ cauchy(0, 3.50);
  tau_TL    ~ cauchy(0, 3.50);
  tau_FW    ~ cauchy(0, 3.50);
  tau_site  ~ cauchy(0, 3.50);
  tau_RS    ~ cauchy(0, 3.50);
  for (s in 1:S) tau_site_RS[s] ~ cauchy(0, 3.50);
